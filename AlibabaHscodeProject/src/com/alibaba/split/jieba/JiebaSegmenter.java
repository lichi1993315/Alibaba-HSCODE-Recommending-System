...
import com.alibaba.split.jieba.viterbi.FinalSeg;
        ...
        for (int i = 0; i < paragraph.length(); ++i) {
            ...
            if (CharacterUtil.ccFind(ch))
                            ...
                            if (token.length() > 3) {
                                ...
                                for (; j < token.length() - 2; ++j) {
                                    ...
                                    if (wordDict.containsWord(gram3))
                                        tokens.add(new SegToken(gram3));
                                }
                            }
                            tokens.add(new SegToken(token));
                        }
                    }
                ...
                if (wordDict.containsWord(paragraph.substring(i, i + 1)))
                    tokens.add(new SegToken(paragraph.substring(i, i + 1)));
                else
                    tokens.add(new SegToken(paragraph.substring(i, i + 1)));
            }
        }
